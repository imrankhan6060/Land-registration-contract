...
contract Land {
    ...
    struct Landreg {
     ...
     // who want to buy land / buyer struct
    ...
    // land inspector who register the land, add land tranfer land
    ...
    // mapping we use struct in value in mapping
    ...
    // ladding a land inspertor only owner can do this.
    ...
    // is seller of the land is varified or not
    ...
    // adding a land with thier detail
    ...
    // get seller all details by address 
    ...
    // will get all buyer detail buy providing address of the buyer
    ...
    //transfer the ownership of the land to another person
    ...
    //paying / transger amount for land 
